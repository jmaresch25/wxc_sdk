...
ACTION_CATALOG = {
    ...
    'usuarios': [
        ...
        {'id': 'usuarios_remover_licencias', 'label': 'Remover licencias', 'dataset': 'users'},
...
ACTION_DESCRIPTIONS: dict[str, str] = {
    ...
    'usuarios_remover_licencias': 'Remueve licencias de usuario.',
...
function rowsForSelectedAction(){
  ...
  try{
    ...
    const actionToDataset = {
      ...
      usuarios_remover_licencias: 'users',
