...
**Catálogo inicial de scripts en menú (sin repeticiones, solo estos)**
...
- Estado confirmado sobre reintentos: el launcher actual ya incorpora reintentos controlados para respuestas `429 Retry-After` (hasta 3 intentos), por lo que en v2 se plantea mantenerlo centralizado y simplificado, no reimplementarlo en cada script.
